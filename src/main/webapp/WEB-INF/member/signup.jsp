					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<div class="custom-control custom-checkbox">
								...
								<label class="custom-control-label" for="aggrement_personal">
						...
						<div class="col-md-6 mb-3">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input"
									id="selectall" onclick="selectAll(this)" name="mkt_opt" value="마케팅 수신 동의">
							...
							<div class="child-custom-control">
								<div class="custom-control custom-checkbox">
									<input type="checkbox"
										...
										<label
										class="custom-control-label" for="aggrement_sms">SMS
										수신 동의</label>
								</div>
								<div class="custom-control custom-checkbox">
									<input type="checkbox"
										class="check_all_list custom-control-input"	id="aggrement_email" 
										onclick="checkSelectAll()" name="mkt_opt_sub" value="email"> <label
